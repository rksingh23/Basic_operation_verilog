...
vlog -work work tb_basic_operation.v

# Loads a new design into the simulator
vsim -gui -novopt work.tb_basic_operation
...
#add wave -position insertpoint sim:/tb_basic_operation/*
